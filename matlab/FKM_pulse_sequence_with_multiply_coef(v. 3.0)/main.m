...
freq_max_div = floor((array_dimention * f_carrier)/ f_sampling);
freq_max_mod = mod((array_dimention * f_carrier), f_sampling);
...
sin_phase_points = phase_accum(num_of_sin_points, array_dimention, f_sampling,... 
